<?php
/**
 * Class WC_Cielo_Credit_Gateway file.
...
/**
 * Cielo Credit Payment Gateway.
 *
 * Provides a cielo credit to pay Payment Gateway.
 *
 * @class       WC_Cielo_Gateway_Credit
 * @extends     WC_Cielo_Payment_Gateway
 */
class WC_Cielo_Credit_Gateway extends WC_Cielo_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->icon               = apply_filters( 'cielo_woocommerce_credit_icon', plugins_url( 'assets/images/cielo.png', plugin_dir_path( __FILE__) . "/../../../../" ) );
		$this->has_fields         = false;
		$this->method_title       = __( 'Cielo - Credit Card', 'cielo-woocommerce' );
		$this->method_description = __( 'Pagamento seguro com cartão de crédito via Cielo.', 'cielo-woocommerce' );
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			'enabled'      => array(
				...
				'type'    => 'checkbox',
				'label'   => __( 'Habilitar Cielo Cartão de crédito', 'cielo-woocommerce' ),
				'default' => 'no',
			),
			'title'        => array(
				'title'       => __( 'Title', 'woocommerce' ),
				'type'        => 'text',
				'description' => __( 'Pagamento seguro com cartão de crédito via Cielo.', 'cielo-woocommerce' ),
				'default'     => _x( 'Cartão de crédito', 'Cielo Cartão de crédito payment method', 'cielo-woocommerce' ),
				'desc_tip'    => true,
			),
			'sandbox'        => array(
			...
			'description'  => array(
				...
				'type'        => 'textarea',
				'description' => __( 'Pagamento seguro com cartão de crédito via Cielo.', 'cielo-woocommerce' ),
				'default'     => __( 'Pagamento seguro com cartão de crédito via Cielo.', 'cielo-woocommerce' ),
				'desc_tip'    => true,
			),
			'instructions' => array(
